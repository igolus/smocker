...
public class MockSpaceView2 extends AbstractConnectionTreeView2<JavaApplicationMocked, ConnectionMocked, CommunicationMocked> implements RefreshableView {

	private static final String BUNDLE_NAME = "BundleUI";

	public MockSpaceView2() {
