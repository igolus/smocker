...
public class SystemPropertyConfiguration {
	// private static final String SMOCKER_CLIENT_HOST = "SMOCKER_TARGET_HOST";
	...
	// "Bad format for property SMOCKER_TARGET_HOST, should be an integer", e,
	...
	// catch (NumberFormatException e) {
	// MessageLogger.logErrorWithMessage(
	// "Bad format for property SMOCKER_DEFAULT_COMM_PORT, should be an
	// integer", e, SystemPropertyConfiguration.class);
	//
	// }
	// }
